...
<?php
$paring = 'SELECT albumid.*, arved.kliendid_id, kliendid.eesnimi, kliendid.perenimi 
FROM albumid 
LEFT JOIN arved ON albumid.id = arved.kliendid_id 
LEFT JOIN kliendid ON arved.kliendid_id = albumid.id';
...
<td>' . $rida['Aasta'] . '</td>
<td>' . $rida['Hind'] . '</td>
<td>' . $rida['eesnimi'] . ' ' . $rida['perenimi'] . '</td>
